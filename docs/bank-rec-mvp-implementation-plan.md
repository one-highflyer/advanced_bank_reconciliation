...
- Unreconcile actions show confirmation prompts. The cancel-linked path explicitly warns that linked Payment Entry or Journal Entry documents will be cancelled.
...
- `bench --site demo.localhost clear-cache`
- `curl -I --max-time 8 http://demo.localhost:8000/bank-rec`
- `curl -I --max-time 8 http://demo.localhost:8000/assets/advanced_bank_reconciliation/bank_rec/assets/index-b47bdffa.js`
