(() => {
  // ../advanced_bank_reconciliation/advanced_bank_reconciliation/public/js/advance_bank_reconciliation_tool/data_table_manager.js
    ...
    get_reconciled_dt_columns() {
      this.reconciled_transactions_columns = [
        ...
        },
        {
          ...
          editable: false,
          width: 100,
          format: (value) => value ? `<span style='color:green;'>${format_currency(value, this.currency)}</span>` : ""
        },
        {
          name: __("Withdrawal"),
          editable: false,
          width: 100,
          format: (value) => value ? `<span style='color:red;'>${format_currency(value, this.currency)}</span>` : ""
        },
        {
  ...
  // ../advanced_bank_reconciliation/advanced_bank_reconciliation/public/js/advance_bank_reconciliation_tool/number_card.js
  frappe.provide("nexwave.accounts.bank_reconciliation");
  nexwave.accounts.bank_reconciliation.NumberCardManager = class NumberCardManager {
    constructor(opts) {
      Object.assign(this, opts);
      this.make_cards();
    }
    make_cards() {
      ...
      chart_data.forEach((summary) => {
        let number_card = new nexwave.accounts.NumberCard(summary);
  ...
  nexwave.accounts.NumberCard = class NumberCard {
    constructor(options) {
  ...
  // ../advanced_bank_reconciliation/advanced_bank_reconciliation/public/js/advance_bank_reconciliation_tool/dialog_manager.js
  frappe.provide("nexwave.accounts.bank_reconciliation");
...
//# sourceMappingURL=advance-bank-reconciliation-tool.bundle.OSUPPYXT.js.map
